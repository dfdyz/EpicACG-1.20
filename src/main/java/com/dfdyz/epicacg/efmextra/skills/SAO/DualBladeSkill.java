...
public class DualBladeSkill extends PassiveSkill {
    ...
    public DualBladeSkill(SkillBuilder<? extends PassiveSkill> builder) {
        super(builder);
    }
    ...
    public void onRemoved(SkillContainer container) {
        container.getExecutor().setMaxStunShield(OrgStunShield);
        container.getExecutor().getEventListener().removeListener(PlayerEventListener.EventType.HURT_EVENT_PRE, EVENT_UUID, 1);
