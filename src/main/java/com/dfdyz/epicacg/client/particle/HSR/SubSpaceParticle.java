...
public class SubSpaceParticle extends Particle {

    public SubSpaceParticle(ClientLevel level, Vec3 pos, int lifetime) {
    ...
    public void render(@NotNull VertexConsumer vertexConsumer, @NotNull Camera camera, float pt) {
        ...
        var col = new Color(0.9f,0.9f,0.9f,  Mth.clampedLerp(_oAlpha,_alpha,pt));
    ...
    public @NotNull ParticleRenderType getRenderType() {
        return EpicACGRenderType.SubMask;
    }
}
